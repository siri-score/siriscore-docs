---
description: >-
  Official documentation for SiriScore, the free, open-source Bitcoin privacy
  tool. Learn how to score PSBTs, raw transactions, and txids for privacy
  leaks before broadcasting.
---
...
<div class="ss-hero">
  ...
  <div class="ss-hero__ctas">
    <a class="md-button md-button--primary" href="https://siriscore.xyz" target="_blank" rel="noopener noreferrer">Try SiriScore</a>
...
- :material-web: **[SiriScore web app](https://siriscore.xyz)**: analyse a transaction right now
...
SiriScore is a free, open-source Bitcoin privacy tool: a pre-broadcast transaction privacy analyzer that checks PSBTs, raw transactions, and txids for privacy leaks — address reuse, round amounts, coinjoin patterns — before chain analysis ever sees them. [Try SiriScore](https://siriscore.xyz), the Bitcoin transaction intelligence layer.
